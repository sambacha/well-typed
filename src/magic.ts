...
// replaced `undefined` usages with the placeholder below so we can exclude it properly on the last definition.

declare const PLACEHOLDER: unique symbol
type Placeholder = typeof PLACEHOLDER

// see from https://stackoverflow.com/a/50375286/3229534
